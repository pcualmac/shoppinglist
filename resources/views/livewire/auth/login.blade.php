<div class="login-page">
    ...
    <main class="card">
        ...
        <form wire:submit.prevent="authenticate">
            ...
            <input id="email" type="email" autocomplete="email" wire:model.defer="email" required>

            <label for="password">Password</label>
            <input id="password" type="password" autocomplete="current-password" wire:model.defer="password" required>
